...
def help_text() -> str:
    return (
        ...
        "- World Root Wrapper creates one extra empty joint at world 0,0,0 above the final exported result.\n"
        "- The wrapper root is added only during final clean-scene FBX export and is not part of the solve itself.\n"
