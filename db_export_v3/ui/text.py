...
FIXED_TIP_TEXT = (
    ...
    "are not part of the production runtime. The optional world-root wrapper is a "
    "final export container only and is not part of the solve. If a future fix is required for "
...
def help_text() -> str:
    return (
        ...
        "- DemBones Hierarchy Mode is passed directly to DemBones CLI as --bindUpdate.\n"
        "- World Root Wrapper creates one extra empty joint at world 0,0,0 above the solved joint roots in the final exported result.\n"
        "- The wrapper root is added only during final clean-scene FBX export, does not parent the mesh geometry, and is not part of the solve itself.\n"
        ...
        "- If World Root Wrapper is enabled, the imported deliverable includes that extra static wrapper joint too.\n"
